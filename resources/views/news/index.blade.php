        ...
        <div class="uc-mobile-menu-pusher">
            <div class="content-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            @foreach($newsList as $news)
                                <div class="col-md-@if($loop->first){{'7'}}@else{{'5'}}@endif">
                                    <div class="feature_article_wrapper">
                                        ...
                                        <div class="feature_article_inner">
                                            ...
                                            <div class="feature_article_title">
                                                <h1><a href="{{ route('show', ["id"=>$news->id]) }}"
                                                       target="_self"> {{ $news->title }} </a></h1>
                                            </div>
                                            <!-- feature_article_title -->

                                            <div class="feature_article_date"><a href="#"
                                                                                 target="_self">{{ $news->author }}</a>,<a
                                                    href="#"
                                                    target="_self">Aug
                                                    4, 2015</a></div>
                ...
                <section id="category_section" class="category_section">
                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="top_article_img">
                                                    <a href="single" target="_self"><img class="img-responsive"
                                                                                         src='{{asset("assets/img/cat-mobi-left-1.jpg")}}'
                                                                                         alt="feature-top">
                                                    </a>
                                                </div>
                                                <!----top_article_img------>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="category_article_title">
                                                    <h2><a href="single" target="_self">Airbnb launches photo-centric
                                                            app for iPads and Android
                                                            tablets. </a></h2>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#"><img class="media-object"
                                                                         src='{{asset("assets/img/cat-mobi-sm1.jpg")}}')}}
                                                                         alt="Generic placeholder image"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <span class="tag purple">Mobile</span>

                                                        <h3 class="media-heading"><a href="single" target="_self">Apple
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#"><img class="media-object"
                                                                         src='{{asset("assets/img/cat-mobi-sm3.jpg")}}'
                                                                         alt="Generic placeholder image"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <span class="tag purple">Mobile</span>

                                                        <h3 class="media-heading"><a href="single" target="_self">The
                                                                Portable Charger or data
                                                                cable</a></h3>
                                                        <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a
                                                                href="#">Eric joan</a></span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#"><img class="media-object"
                                                                         src='{{asset("assets/img/cat-mobi-sm2.jpg")}}'
                                                                         alt="Generic placeholder image"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <span class="tag purple">Mobile</span>

                                                        <h3 class="media-heading"><a href="single" target="_self">Iphone
                                                                6 launches white & Grey
                                                                colors handset</a></h3>
                                                        <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a
                                                                href="#">Eric joan</a></span>
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#"><img class="media-object"
                                                                         src='{{asset("assets/img/cat-mobi-sm4.jpg")}}'
                                                                         alt="Generic placeholder image"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <span class="tag purple">Mobile</span>

                                                        <h3 class="media-heading"><a href="single" target="_self">Fully
                                                                new look slim handset
                                                                like</a></h3>
                                                        <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a
                                                                href="#">Eric joan</a></span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <a href="single" target="_self"><img class="img-responsive"
                                                                                             src='{{asset("assets/img/tab_top1.jpg")}}'
                                                                                             alt="feature-top">
                                                        </a>
                                                    </div>
                                                    <!-- top_article_img -->
                                                    ...
                                                    <span class="tag pink"><a href="category.html"
                                                                              target="_self">Tablet</a></span>

                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">Sony launce a new Android
                                                                tablets for new
                                                                generation </a></h2>
                                                    </div>
                                                    <!-- category_article_title -->

                                                    <div class="article_date"><a href="#">10Aug- 2015</a>, by: <a
                                                            href="#">Eric joan</a></div>
                                                    <!----article_date------>
                                                    <!-- article_date -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <a href="single" target="_self">
                                                            <img class="img-responsive" src='{{asset("assets/img/tab_top2.jpg")}}'
                                                                 alt="feature-top">
                                                        </a>
                                                    </div>
                                                    <!-- top_article_img -->
                                                    ...
                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">Technology market see the
                                                                new Android tablets </a>
                                                        </h2>
                                                    </div>
                                                    <!-- category_article_title -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <a href="single" target="_self">
                                                            <img class="img-responsive" src='{{asset("assets/img/gad_top1.jpg")}}'
                                                                 alt="feature-top">
                                                        </a>
                                                    </div>
                                                    <!-- top_article_img -->
                                                    ...
                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">A good news for gadget users
                                                                Ds tech comming soon</a>
                                                        </h2>
                                                    </div>
                                                    <!-- category_article_title -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <img class="img-responsive" src='{{asset("assets/img/gad_top2.jpg")}}'
                                                             alt="feature-top">
                                                    </div>
                                                    <!-- top_article_img -->
                                                    ...
                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">Apple launches photo-centric
                                                                app for iPads and Android
                                                                tablets</a></h2>
                                                    </div>
                                                    <!-- category_article_title -->
                                                    ...
                                                    <div class="article_social">
                                                        <span><i class="fa fa-share-alt"></i><a
                                                                href="#">424</a>Shares</span>
                                                        <span><i class="fa fa-comments-o"></i><a href="#">4</a>Comments</span>
                                                    </div>
                                                    <!-- article_social -->
                                    ...
                                    <div class="category_article_wrapper">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="top_article_img">
                                                    <a href="single" target="_self">
                                                        <img class="img-responsive" src='{{asset("assets/img/cam_left1.jpg")}}'
                                                             alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <div class="category_article_title">
                                                    <h2><a href="single" target="_self">Yasaki camera launches new
                                                            generic hi-speed </a></h2>
                                                </div>
                                                <!-- category_article_title -->
                                    ...
                                    <div class="category_article_wrapper">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="top_article_img">
                                                    <a href="single" target="_self">
                                                        <img class="img-responsive" src='{{asset("assets/img/cam_left2.jpg")}}'
                                                             alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- top_article_img -->
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <div class="category_article_title">
                                                    <h2><a href="single" target="_self">DSLR is the most old camera at
                                                            this time </a></h2>
                                                </div>
                                                <!-- category_article_title -->
                                    ...
                                    <div class="category_article_wrapper">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="top_article_img">
                                                    <a href="single" target="_self">
                                                        <img class="img-responsive" src='{{asset("assets/img/cam_left3.jpg")}}'
                                                             alt="feature-top">
                                                    </a>
                                                </div>
                                                <!-- media_social -->
                                            ...
                                            <div class="col-md-7">
                                                <span class="tag orange"><a href="single"
                                                                            target="_self">Camera</a></span>

                                                <div class="category_article_title">
                                                    <h2><a href="single" target="_self">Canon Camera launches photo
                                                            centric Android</a></h2>
                                                </div>
                                                <!-- category_article_title -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <a href="single" target="_self">
                                                            <img class="img-responsive" src='{{asset("assets/img/design_top1.jpg")}}'
                                                                 alt="feature-top">
                                                        </a>
                                                    </div>
                                                    <!-- top_article_img -->

                                                    <span class="tag blue"><a href="category.html"
                                                                              target="_self">Design</a></span>

                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">Marketing Tranportation Fast
                                                                and </a></h2>
                                                    </div>
                                                    <!-- category_article_title -->

                                                    <div class="category_article_date"><a href="#">10Aug- 2015</a>, by:
                                                        <a href="#">Eric joan</a></div>
                                                    <!----category_article_date------>
                                                    <!-- category_article_date -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <a href="single" target="_self">
                                                            <img class="img-responsive" src='{{asset("assets/img/design_top2.jpg")}}'
                                                                 alt="feature-top">
                                                        </a>
                                                    </div>
                                                    <!-- top_article_img -->
                                                    ...
                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">Theme Hippo launches
                                                                Unship </a></h2>
                                                    </div>
                                                    <!-- category_article_title -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <a href="single" target="_self">
                                                            <img class="img-responsive" src='{{asset("assets/img/design_top3.jpg")}}'
                                                                 alt="feature-top">
                                                        </a>
                                                    </div>
                                                    <!-- top_article_img -->
                                                    ...
                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">Huge Ultimate website
                                                                builder </a></h2>
                                                    </div>
                                                    <!-- category_article_title -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="category_article_body">
                                                    <div class="top_article_img">
                                                        <img class="img-responsive" src='{{asset("assets/img/design_top4.jpg")}}'
                                                             alt="feature-top">
                                                    </div>
                                                    <!-- top_article_img -->
                                                    ...
                                                    <div class="category_article_title">
                                                        <h2><a href="single" target="_self">Just another theme
                                                                xdesign</a></h2>
                                                    </div>
                                                    <!-- category_article_title -->
                            ...
                            <div class="col-md-4">
                                <div class="widget">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src='{{asset("assets/img/pop_right1.jpg")}}'
                                                             alt="Generic placeholder image"></a>
                                        </div>
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Canon launches photo centric 00214 Model
                    ...
                    <span>
                        <a href="single" target="_self"> <i class="fa fa-share-alt"></i>424</a> Shares
                    </span>
                                                <span>
                        <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                    </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src='{{asset("assets/img/pop_right2.jpg")}}'
                                                             alt="Generic placeholder image"></a>
                                        </div>
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Samsung galaxy note are the supper
                                                    mobile of all products.</a>
                                            </h3>
                    ...
                    <span>
                        ...
                        <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src='{{asset("assets/img/pop_right3.jpg")}}'
                                                             alt="Generic placeholder image"></a>
                                        </div>
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Apple launches photo-centric wrist watch
                                                    for Android</a>
                                            </h3>
                                            <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                    ...
                    <span>
                        ...
                        <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object" src='{{asset("assets/img/pop_right4.jpg")}}'
                                                             alt="Generic placeholder image"></a>
                                        </div>
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Kodak Hi-Speed shutter double shot
                                                    camera comming soon</a>
                                            </h3>
                                            <span class="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                    ...
                    <span>
                        ...
                        <a href="single" target="_self"><i class="fa fa-comments-o"></i>4</a> Comments
                                ...
                                <div class="widget hidden-xs m30">
                                    <img class="img-responsive widget_img" src='{{asset("assets/img/right_add5.jpg")}}'
                                         alt="add_one">
                                </div>
                                <!-- Advertisement -->
                                ...
                                <div class="widget reviews m30">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">DSLR is the most old camera at this time
                                                    readmore about new
                                                    products</a>
                                            </h3>
                                            <span class="rating">
                    ...
                    <i class="fa fa-star-half-full"></i>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body"><h3 class="media-heading"><a href="single"
                                                                                             target="_self">Samsung is
                                                    the best
                    ...
                    <i class="fa fa-star-half-full"></i>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Yasaki camera launches new generic
                    ...
                    <i class="fa fa-star-half-full"></i>
                                ...
                                <div class="widget hidden-xs m30">
                                    <img class="img-responsive widget_img" src='{{asset("assets/img/right_add6.jpg")}}'
                                         alt="add_one">
                                </div>
                                <!-- Advertisement -->
                                ...
                                <div class="widget m30">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3 class="media-heading">
                                                <a href="single" target="_self">Samsung is the best mobile in the
                                                    android market.</a>
                                            </h3>
                                ...
                                <div class="widget m30">
                                    ...
                                    <div class="widget_body"><img class="img-responsive left"
                                                                  src='{{asset("assets/img/editor.jpg")}}'
                ...
                <section id="footer_section" class="footer_section">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="footer_widget_title"><h3><a href="category.html" target="_self">About
                                            Tech</a></h3></div>
                                <div class="logo footer-logo">
                                    ...
                                    <p>Competently conceptualize go forward testing procedures and B2B expertise.
                                        Phosfluorescently
                                        cultivate principle-centered methods.of empowerment through fully
                                        researched.</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h3 class="media-heading">
                                            <a href="single">Apple launches photo-centric wrist watch for Android</a>
                                        </h3>
                                        <span class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
